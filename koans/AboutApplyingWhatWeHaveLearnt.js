...
describe("About Applying What We Have Learnt", function() {
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    var ingredientCount = _(products).chain()
                                     .map(function(product) {return product.ingredient;})
                                     .flatten()
                                     .reduce(function(countList, food) {
                                       console.log(food);
                                       countList[food] = (countList[food] || 0) + 1;
                                       return countList;
                                     }, {})
                                     .value()
